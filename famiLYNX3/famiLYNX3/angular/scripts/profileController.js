(function () {
    angular
    .module('famiLYNX')
    .controller('profileController', ['profileService', 'familyCreator', 'familyDeleter', 'convoCreator', 'msgCreator',
        function (profileService, familyCreator, familyDeleter, convoCreator, msgCreator) {
        ...
        self.addMessage = function (message, convo) {
            msgCreator.addMsg(message, convo).then(function (data) {
                ...
                self.selectedFamily.currentConvo.MessageList.push(data);
